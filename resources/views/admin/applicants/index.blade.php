                      ...
                      <div class="card-body bg-white text-primary  mailbox-widget pb-0">
                        ...
                        <nav >
                          <div class="nav nav-tabs" id="nav-tab" role="tablist">
                            ...
                            <a class="nav-link" id="nav-profile-tab" data-bs-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">HIRED</a>
                          </div>
                        </nav>
                      <div>
                        <!-- content -->
                        <div class="tab-content" id="nav-tabContent">
                          ...
                          <div class="table-responsive mt-3">
                                    <table class="table table-applicants applicants-table">
                                      <thead>
                                        <tr>
